...
- `voltage_limit=3.0 V`, `velocity_limit=100`, `PID_velocity P=0.05 I=1.0 D=0`, `LPF_velocity.Tf=0.02`, `P_angle.P=10`. (Raised from 1.0 V / 20 rad/s for high-speed runs — see the overtravel note below; halls must sit with ≥20% travel of clear space beyond them.)
